...
public class activitysub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Truy vấn dữ liệu từ mã số nhận được; Hiển thị dữ liệu Mã bài hát, Tên bài hát, Lời bài hát, Tác giả, Trạng thái Thích lên activitysub
        Cursor c = MainActivity.database.rawQuery("SELECT * FROM AriangSongList WHERE MABH LIKE '" + maso + "'", null);
        c.moveToFirst();
        ...
        btnthich.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MainActivity.database.update("AriangSongList", values, "MABH=?", new String[]{txtmaso.getText().toString()});
                btnthich.setVisibility(View.INVISIBLE);
                btnkhongthich.setVisibility(View.VISIBLE);
            }
        });
